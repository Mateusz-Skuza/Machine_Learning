...
def record(model_path, algo_class, filename, seconds=30, env_name = ENV_NAME):
...
if __name__ == "__main__":
    ...
    ppo_path = train_model(PPO, "PPO", "test_ppo_cartpole")
    record(ppo_path, PPO, "logs/videos/ppo_cartpole_30s.mp4")

    dqn_path = train_model(DQN, "DQN", "test_dqn_cartpole")
    record(dqn_path, DQN, "logs/videos/dqn_cartpole_30s.mp4")